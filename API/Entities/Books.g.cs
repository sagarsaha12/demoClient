...
namespace demoClient.Entities
{
    ...
    public class Books
    {
        ...
        /// <summary>
        /// Foreign key referencing the Publication to which the Books belongs 
        /// </summary>
        public Guid? PublicationId { get; set; }

        /// <summary>
        /// Navigation property representing the associated Publication
        /// </summary>
        [ForeignKey("PublicationId")]
        public Publication? PublicationId_Publication { get; set; }
    }
}