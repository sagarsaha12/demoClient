...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "demoClient", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<demoClientContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "demoClient API v1");
