...
namespace demoClient.Data
{
    public class demoClientContext : DbContext
    {
        protected override void OnConfiguring(Microsoft.EntityFrameworkCore.DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-VG8KTFE;Initial Catalog=T729947_demoClient;Persist Security Info=True;user id=sa;password=admin!234;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
